...
begin
  ...
  if v_mode = 'organization_signup' then
    ...
    if v_industry_key not in ('fitness', 'automotive', 'insurance', 'physio', 'energy') then
  ...
  if v_mode = 'organization_signup' then
    ...
    values (v_organization_name, v_seat_limit, v_industry_key, v_industry_key)
...
CREATE TABLE IF NOT EXISTS "public"."complaint_management_avatar_snapshots" (
    ...
    CONSTRAINT "complaint_management_avatar_snapshots_industry_key_check" CHECK (("industry_key" = ANY (ARRAY['fitness'::"text", 'automotive'::"text", 'insurance'::"text", 'physio'::"text", 'energy'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."full_sales_avatar_snapshots" (
    ...
    CONSTRAINT "full_sales_avatar_snapshots_industry_key_check" CHECK (("industry_key" = ANY (ARRAY['fitness'::"text", 'automotive'::"text", 'insurance'::"text", 'physio'::"text", 'energy'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."organizations" (
    ...
    CONSTRAINT "organizations_industry_key_check" CHECK (("industry_key" = ANY (ARRAY['fitness'::"text", 'automotive'::"text", 'insurance'::"text", 'physio'::"text", 'energy'::"text"]))),
