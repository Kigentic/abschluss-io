    ...
    fullSales: [
      {
        ...
        avatarProfessionOrContext: "Eigenheimbesitzer mit technischer Grundaffinitaet",
        avatarSecondaryContext: "schwankt zwischen Einzelmassnahme und Kombiloesung aus PV, Speicher und Heizoptimierung",
        openingMessage:
          "Hallo, ich bin Robert, 44 und Eigentümer eines Einfamilienhauses. Unsere Strom- und Heizkosten sind in den letzten Jahren stark gestiegen. Ich habe Angebote gesehen, bin aber unsicher, ob ich nur einzelne Punkte angehe oder direkt eine Kombiloesung mit PV, Speicher und Heizoptimierung aufsetze.\n\nDu kannst das Gespräch gerne beginnen.",
      },
      {
        avatarAge: 49,
        avatarEmotionalTone: "vorsichtig, sicherheitsorientiert und langfristig denkend",
        avatarGender: "female",
        avatarGoal: "Heizkosten stabilisieren und Foerdermittel sinnvoll nutzen",
        ...
        avatarSecondaryContext: "moechte Umweltaspekte mit Wirtschaftlichkeit verbinden, ohne Foerderfenster zu verpassen",
        openingMessage:
          "Hi, ich bin Alina, 49 und besitze ein Einfamilienhaus. Unsere Heizanlage ist in die Jahre gekommen und die Nebenkosten steigen. Ich suche eine Loesung, die Heizkosten stabilisiert, Foerdermittel nutzt und trotzdem wirtschaftlich bleibt.\n\nDu kannst das Gespräch gerne beginnen.",
      },
      {
        avatarAge: 52,
        ...
        avatarName: "Mehmet",
        avatarPrimaryProblem: "Mehrfamilienhaeuser mit hohem Energieverbrauch und steigenden Instandhaltungskosten",
        ...
        openingMessage:
          "Hallo, ich bin Mehmet, 52 und halte mehrere Mehrfamilienhaeuser im Bestand. Die Energiekosten laufen mir davon und ich will die Rendite pro Objekt stabilisieren. Ich brauche keine langen Praesentationen, sondern eine saubere Business-Logik.\n\nDu kannst das Gespräch gerne beginnen.",
      },
      {
        avatarAge: 58,
        avatarEmotionalTone: "partnerschaftlich, werteorientiert und abwaegend",
        avatarGender: "female",
        avatarGoal: "als Ehepaar eine wirtschaftliche und nachhaltige Gesamtloesung treffen",
        avatarLifeStage: "Ehepaar mit schuldenfreiem Eigenheim",
        avatarName: "Laura",
        avatarPrimaryProblem: "Unsicherheit zwischen Umweltanspruch, Komfort und Investitionshoehe",
        avatarProfessionOrContext: "Ehepaar als gemeinsame Entscheider im Eigenheim (B2C)",
        avatarSecondaryContext: "will Strom sparen, guenstiger heizen und gleichzeitig den Objektwert steigern",
        openingMessage:
          "Hi, ich bin Laura, 58. Mein Mann und ich entscheiden gemeinsam ueber unser Eigenheim. Wir wollen Strom sparen, guenstiger heizen und den Hauswert steigern, aber wir sind uns unsicher, welche Kombination wirklich sinnvoll ist.\n\nDu kannst das Gespräch gerne beginnen.",
      },
      {
        avatarAge: 63,
        avatarEmotionalTone: "analytisch, strukturiert und risikobewusst",
        avatarGender: "male",
        avatarGoal: "Foerderfaehige Massnahmen nutzen und gleichzeitig den Cashflow der Objekte stabil halten",
        avatarLifeStage: "Bestandshalter mit langfristigem Horizont",
        avatarName: "Stefan",
        avatarPrimaryProblem: "unsichere Investitionsentscheidung bei mehreren sanierungsbeduerftigen Objekten",
        avatarProfessionOrContext: "Mehrfamilienhausbesitzer mit mehreren Mietobjekten (B2B)",
        avatarSecondaryContext: "achtet stark auf Foerderlogik, Finanzierung und technische Risiken",
        openingMessage:
          "Hallo, ich bin Stefan, 63 und besitze mehrere Mehrfamilienhaeuser. Ich weiss, dass energetische Sanierung noetig ist, aber ich will exakt verstehen, welche Massnahmen sich rechnen, welche Foerderung realistisch ist und wie sich das auf meinen Cashflow auswirkt.\n\nDu kannst das Gespräch gerne beginnen.",
      },
      {
        avatarAge: 71,
        avatarEmotionalTone: "ruhig, vorsichtig und sicherheitsorientiert",
        avatarGender: "female",
        avatarGoal: "im Alter planbare Energiekosten und moeglichst wenig technische Komplexitaet",
        ...
        openingMessage:
          "Hallo, ich bin Sabine, 71 und lebe im eigenen Haus. Die Heizkosten sind in den letzten Jahren deutlich gestiegen, und ich will eine Loesung, die fuer mich im Ruhestand planbar bleibt. Mir sind einfache Schritte und Sicherheit wichtiger als komplizierte Technik.\n\nDu kannst das Gespräch gerne beginnen.",
      },
    ],
